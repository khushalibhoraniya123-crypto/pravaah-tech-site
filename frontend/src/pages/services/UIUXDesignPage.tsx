  ...
  return (
    <div className="pt-16 sm:pt-20 min-h-screen bg-transparent">
      ...
      <section className="relative py-8 sm:py-12 overflow-hidden bg-gradient-to-b from-white/80 via-[#F8FAFD]/90 to-transparent border-b border-[#E8EDF5]">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[350px] bg-gradient-to-tr from-[#6C3FE8]/15 via-[#00D2FF]/10 to-transparent rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
            {designCapabilities.map((cap, idx) => {
              const Icon = cap.icon;
              return (
                <div key={idx} className="p-5 sm:p-6 rounded-2xl bg-gradient-to-b from-white to-[#F5F8FD] border border-[#D2DEEE] hover:border-pink-500/50 hover:shadow-elevated transition-all flex gap-4">
                  <div className="w-10 h-10 rounded-xl bg-pink-500/10 text-pink-600 flex items-center justify-center shrink-0 border border-pink-200/50">
