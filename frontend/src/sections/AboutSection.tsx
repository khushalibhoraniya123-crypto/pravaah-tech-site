...
export const AboutSection: React.FC<AboutSectionProps> = ({ onLearnMore }) => {
  return (
    <section id="about" className="py-20 md:py-28 bg-[#FFFFFF] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl bg-gradient-to-br from-[#07152F] to-[#0B1B3A] p-8 sm:p-10 text-white shadow-elevated border border-white/10 overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="flex items-center justify-between pb-2 border-b border-white/10">
                  ...
                  <span className="flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider bg-white/10 text-[#38BDF8] border border-white/10 px-2.5 py-1 rounded-full">
                    <Sparkles className="w-3.5 h-3.5 text-[#9B7BFF]" />
                ...
                <div className="pt-4 border-t border-white/10 space-y-3">
                  <div className="flex items-center gap-3 text-xs sm:text-sm font-semibold text-slate-200">
                    <div className="w-6 h-6 rounded-lg bg-[#1769E0]/30 text-[#38BDF8] flex items-center justify-center shrink-0">
                  ...
                  <div className="flex items-center gap-3 text-xs sm:text-sm font-semibold text-slate-200">
                    <div className="w-6 h-6 rounded-lg bg-[#6C3FE8]/30 text-[#9B7BFF] flex items-center justify-center shrink-0">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="space-y-3">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#0B1B3A]">
                Who We Are
              </h3>
            </div>
            ...
            <div className="space-y-4 text-base text-[#475467] leading-relaxed">
              ...
              <p className="p-4 rounded-2xl bg-[#F7F9FC] border-l-4 border-[#1769E0] text-[#0B1B3A] font-medium text-sm">
