...
export const TechCard: React.FC<TechCardProps> = ({ item }) => {
  ...
  return (
    <div className="relative p-[1.8px] rounded-2xl overflow-hidden group transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_12px_28px_rgba(23,105,224,0.2)] cursor-default h-full">
      ...
      <div 
        aria-hidden="true"
        className="absolute -inset-[180%] animate-[spin_40s_linear_infinite] bg-[conic-gradient(from_0deg_at_50%_50%,transparent_0_240deg,#00D2FF_280deg,#1769E0_310deg,#6638E8_335deg,#EC4899_355deg,#FFFFFF_360deg)] blur-md opacity-45 group-hover:opacity-85 pointer-events-none transition-opacity duration-300"
      />

      {/* 2. Moving Light Trail Around Exact Border */}
      <div 
        aria-hidden="true"
        className="absolute -inset-[180%] animate-[spin_40s_linear_infinite] bg-[conic-gradient(from_0deg_at_50%_50%,transparent_0_240deg,#00D2FF_280deg,#1769E0_310deg,#6638E8_335deg,#EC4899_355deg,#FFFFFF_360deg)] pointer-events-none opacity-70 group-hover:opacity-100 transition-opacity duration-300"
      />
